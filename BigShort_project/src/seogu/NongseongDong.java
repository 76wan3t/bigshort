...
public class NongseongDong {
	static String base_url = "http://home.sarangbang.com/linead/list.html/?menu=apt&submenu=&code_area1=1&code_area2=12&dong=%B3%F3%BC%BA%B5%BF";
	//static String base_url2="&nScale=20&total_page=4&now_location=%2Flinead%2Flist.html%2F&sort_default=&sort_km=&sort_year=&sort_money=&dong=%B1%A4%C3%B5%B5%BF&menu=apt&submenu=&code_area1=1&code_area2=12";
	//static int page = 1;
	//static int total = 4;
	//static String comlete_page = base_url + page + base_url2;
	static String area = "seogu";
	static String seq = "seogu_seq.NEXTVAL";
	
	public void nongseongdong() throws IOException {
