...
public class SeoGuTotal {
	
	static String base_url = "http://home.sarangbang.com/linead/list.html?nPage=";
    static String base_url2="&nScale=20&total_page=110&now_location=%2Flinead%2Flist.html&sort_default=&sort_km=&sort_year=&sort_money=&dong=&menu=apt&submenu=&code_area1=1&code_area2=12";
    static int page = 1;
