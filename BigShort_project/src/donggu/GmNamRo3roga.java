...
public class GmNamRo3roga {
	static String base_url = "http://home.sarangbang.com/linead/list.html/?menu=apt&submenu=&code_area1=1&code_area2=11&dong=%B1%DD%B3%B2%B7%CE3%B0%A1";
	//static String base_url2="&nScale=20&total_page=4&now_location=%2Flinead%2Flist.html%2F&sort_default=&sort_km=&sort_year=&sort_money=&dong=%BA%BB%C3%CC%B5%BF&menu=apt&submenu=&code_area1=1&code_area2=14";
	//static int page = 1;
	//static int total = 4;
	...
	public void gmnamro3roga() throws IOException {
