...
public class YangNimDong {
	static String base_url = "http://home.sarangbang.com/linead/list.html/?menu=apt&submenu=&code_area1=1&code_area2=13&dong=%BE%E7%B8%B2%B5%BF";
	//static String base_url2="&nScale=20&total_page=5&now_location=%2Flinead%2Flist.html%2F&sort_default=&sort_km=&sort_year=&sort_money=&dong=%B3%EB%B4%EB%B5%BF&menu=apt&submenu=&code_area1=1&code_area2=13";
	//static int page = 1;
	//static int total = 5;
	//static String comlete_page = base_url + page + base_url2;
	static String area = "namgu";
	static String seq = "namggu_seq.NEXTVAL";
	
	public void yangnimdong() throws IOException {
