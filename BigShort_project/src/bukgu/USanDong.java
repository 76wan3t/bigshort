...
public class USanDong {
	static String base_url = "http://home.sarangbang.com/linead/list.html/?nPage=";
	static String base_url2="&nScale=20&total_page=2&now_location=%2Flinead%2Flist.html%2F&sort_default=&sort_km=&sort_year=&sort_money=&dong=%BF%EC%BB%EA%B5%BF&menu=apt&submenu=&code_area1=1&code_area2=14";
	static int page = 1;
	static int total = 2;
	...
	public void usandong() throws IOException {
