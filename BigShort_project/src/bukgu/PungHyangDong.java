...
public class PungHyangDong {
	static String base_url = "http://home.sarangbang.com/linead/list.html/?menu=apt&submenu=&code_area1=1&code_area2=14&dong=%C7%B3%C7%E2%B5%BF";
	//static String base_url2="&nScale=20&total_page=3&now_location=%2Flinead%2Flist.html%2F&sort_default=&sort_km=&sort_year=&sort_money=&dong=%C1%DF%C8%EF%B5%BF&menu=apt&submenu=&code_area1=1&code_area2=14";
	//static int page = 1;
	//static int total = 3;
	//static String comlete_page = base_url + page + base_url2;
	static String area = "bukgu";
	static String seq = "bukgu_seq.NEXTVAL";
	
	public void pungheungdong() throws IOException {
