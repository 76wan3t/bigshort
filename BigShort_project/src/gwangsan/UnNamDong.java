...
public class UnNamDong {

	static String base_url = "http://home.sarangbang.com/linead/list.html/?nPage=";
	static String base_url2="&nScale=20&total_page=17&now_location=%2Flinead%2Flist.html%2F&sort_default=&sort_km=&sort_year=&sort_money=&dong=%BF%EE%B3%B2%B5%BF&menu=apt&submenu=&code_area1=1&code_area2=15";
	static int page = 1;
	static int total = 17;
	...
	public void unnamdong() throws IOException {
        ...
        while(page <= total) {
            ...
            String dongname = doc.select("div.viewContLinead > table > tbody > tr > td[colspan='2']").text().substring(0, 3); //동대를 출력하기 위해서
           	...
           	if(deal2.equals("매")) {
                ...
                bSdAo.insert(bDto ,area, seq);
                	...
                	if(mreview.equals("천")) {
                		...
                		if(mreview.equals("천")&&count2==1) {
                		number2 = number2 * 10000000; //"천"자가 들어가면 천만원을 곱한다.
                    	...
                    	number3 = Integer.parseInt(monthlynumber2); // 타입 변환
                			...
                			number2 = number2 * 1000000; //"천"자가 들어가면 백만원을 곱한다.
                		...
                		number2 = number2 * 100000000; //"억"자가 들어가면 1억원을 곱한다.
                    	...
                    	number3 = number3 * 10000;// 월세는 만원 단위라서 만원을 곱해준다.
                    		...
                    		number2 = number2 * 10000000; //"억"자가 들어가면 1억원을 곱한다.
                    		monthly2 = doc.select("div.viewLineadPrice").text().substring(7, 10);//월세만 가져오기
                        	monthlynumber2 = monthly2.replaceAll("[^0-9]", ""); // 월세에서 숫자만 빼오기
                        	number3 = Integer.parseInt(monthlynumber2); // 타입 변환
                        	number3 = number3 * 10000;// 월세는 만원 단위라서 만원을 곱해준다.
