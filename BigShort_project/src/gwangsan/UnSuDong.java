...
public class UnSuDong {

	static String base_url = "http://home.sarangbang.com/linead/list.html/?menu=apt&submenu=&code_area1=1&code_area2=15&dong=%BF%EE%BC%F6%B5%BF";
	/*static String base_url2="&nScale=20&total_page=18&now_location=%2Flinead%2Flist.html%2F&sort_default=&sort_km=&sort_year=&sort_money=&dong=%BF%EE%B3%B2%B5%BF&menu=apt&submenu=&code_area1=1&code_area2=15";
	static int page = 1;
	static int total = 18;
	...
	public void unsudong() throws IOException {
