...
public class Sanwoldong {
	
	static String base_url = "http://home.sarangbang.com/linead/list.html/?nPage=";
	static String base_url2="&nScale=20&total_page=10&now_location=%2Flinead%2Flist.html%2F&sort_default=&sort_km=&sort_year=&sort_money=&dong=%BB%EA%BF%F9%B5%BF&menu=apt&submenu=&code_area1=1&code_area2=15";
	static int page = 1;
	static int total = 10;
	...
	public void sanwoldong() throws IOException {
