...
public class MemUpdateAction implements Action{
	...
	public ActionForward excute(HttpServletRequest request, HttpServletResponse response)
		...
		String mbisnumber = request.getParameter("brn");
		...
		System.out.println(mid+mname+mphone+memail+memail2+mbisnumber+mbisname+mbisphone+mjusonum+mjuso+mjuso2);
		MemberDAO mDao = MemberDAO.getInstance();
		MemberDTO mDto = new MemberDTO(mid, mname, mphone, mbisname, mbisnumber, mbisphone, mjusonum, mjuso, mjuso2, memail, memail2);
